...
var packageName = 'webix:skin-metro';  // https://atmospherejs.com/webix/skin-metro
...
Package.describe({
  name: packageName,
  summary: 'Metro skin for Webix UI',
  version: version,
  git: 'https://github.com/MeteorPackaging/webix-skin-metro',
...
Package.onUse(function (api) {
  ...
  api.addFiles(['webix/codebase/skins/debug/metro.css'], 'client');
